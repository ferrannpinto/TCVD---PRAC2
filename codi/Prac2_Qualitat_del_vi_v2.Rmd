...
Examinem els valors resum de cada tipus de variable pel dataset total.
...
En una cerca s'ha trobat que els vins blancs poden tenir com a màxim 1.5 g/l.

```{r}
nrow(wine[(wine$volatile.acidity > 1.5),])
```

Tenim una fila amb un valor de acidesa volàtil superior a 1.5, la eliminem.

```{r}
wine <- wine[!(wine$volatile.acidity > 1.5),]
```
...
Considerem anòmals els valors per sobre de 30, malgrat que s'ha trobat que el màxim de sucre residual permès és de 45; perquè els valors superiors a 30 s'observem força allunyats de la resta.
...
Malgrat hi ha molts valors atípics, no es consideren anòmals i per tant no els tractem, al haver trobat que el màxim en diferents paísos ronda el 0.6. 
...
Veiem com tenim varis valors extrems. Considerem anòmal el que és superior a 350 ja que és el límit màxim permès. Eliminem aquest registre.

```{r}
wine <- wine[!(wine$total.sulfur.dioxide > 350),]
```
...
hist(wine$density, main="Histogram density", xlab="density")
...
hist(wine$sulphates, main="Histogram sulphates", xlab="sulphates")
...
hist(wine$alcohol, main="Histograma alcohol", xlab="alcohol")
...
Observem els histogrames de cada variable comparant-ho amb la distribució normal ideal per cada variable.

```{r}
library(ggplot2)

ggplot(data = wine, aes(x=fixed.acidity)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$fixed.acidity), sd = sd(wine$fixed.acidity))) +
  ggtitle("Histograma + curva normal ideal de fixed acidity") + theme_bw()

ggplot(data = wine, aes(x=volatile.acidity)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$volatile.acidity), sd = sd(wine$volatile.acidity))) +
  ggtitle("Histograma + curva normal ideal de volatile acidity") + theme_bw()

ggplot(data = wine, aes(x=citric.acid)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$citric.acid), sd = sd(wine$citric.acid))) +
  ggtitle("Histograma + curva normal ideal de citric acid") + theme_bw()

ggplot(data = wine, aes(x=residual.sugar)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$residual.sugar), sd = sd(wine$residual.sugar))) +
  ggtitle("Histograma + curva normal ideal de residual sugar") + theme_bw()

ggplot(data = wine, aes(x=chlorides)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$chlorides), sd = sd(wine$chlorides))) +
  ggtitle("Histograma + curva normal ideal de chlorides") + theme_bw()

ggplot(data = wine, aes(x=free.sulfur.dioxide)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$free.sulfur.dioxide), sd = sd(wine$free.sulfur.dioxide))) +
  ggtitle("Histograma + curva normal ideal de free sulfur dioxide") + theme_bw()

ggplot(data = wine, aes(x=total.sulfur.dioxide)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$total.sulfur.dioxide), sd = sd(wine$total.sulfur.dioxide))) +
  ggtitle("Histograma + curva normal ideal de total sulfur dioxide") + theme_bw()

ggplot(data = wine, aes(x=density)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$density), sd = sd(wine$density))) +
  ggtitle("Histograma + curva normal ideal de density") + theme_bw()

ggplot(data = wine, aes(x=pH)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$pH), sd = sd(wine$pH))) +
  ggtitle("Histograma + curva normal ideal de pH") + theme_bw()

ggplot(data = wine, aes(x=sulphates)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$sulphates), sd = sd(wine$sulphates))) +
  ggtitle("Histograma + curva normal ideal de sulphates") + theme_bw()

ggplot(data = wine, aes(x=alcohol)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$alcohol), sd = sd(wine$alcohol))) +
  ggtitle("Histograma + curva normal ideal de alcohol") + theme_bw()

ggplot(data = wine, aes(x=quality)) + geom_histogram(aes(y = ..density.., fill = ..count..)) + scale_fill_gradient(low = "#DCDCDC", high = "#7C7C7C") +
  stat_function(fun = dnorm, colour = "firebrick", args = list(mean = mean(wine$quality), sd = sd(wine$quality))) +
  ggtitle("Histograma + curva normal ideal de quality") + theme_bw()
...
Pel que fa a aquest model, és significatiu (p-valor menor que 0.05). Pel que fa a la bondat de l'ajust, el coeficient de determinació R2 és capaç d'explicar el 19.9%  de la variabilitat present en la variable de resposta (quality) mitjançant la variable independent (alcohol).
...
S'observa que les variables més usades per predir si un vi és bo o no amb el model d'arbre de predicció són *alcohol*, *volatile.acidity*, i *residual.sugar*
...
S'observa que les variables més usades en el model del vi negre per predir la qualitat són *alcohol* i *fixed.acidity*.
...
El model de "Random Forest" discrimina millor les dades, al ser la seva àrea sota la curva aproximadament 0.92 i la de la regressió logística 0.82.
